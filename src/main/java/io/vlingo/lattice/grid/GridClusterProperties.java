...
public class GridClusterProperties {
  ...
  public static io.vlingo.cluster.model.Properties allNodes(final int startPort) {
  ...
  public static io.vlingo.cluster.model.Properties oneNode(final int startPort) {
