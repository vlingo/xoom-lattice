...
public class ProjectionDispatcher__Proxy implements io.vlingo.xoom.lattice.model.projection.ProjectionDispatcher {

  private static final String projectToRepresentation1 = "projectTo(io.vlingo.xoom.lattice.model.projection.Projection, java.lang.String)";
  ...
  public void projectTo(io.vlingo.xoom.lattice.model.projection.Projection arg0, java.lang.String[] arg1) {
    if (!actor.isStopped()) {
