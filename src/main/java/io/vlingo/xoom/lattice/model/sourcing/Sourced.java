...
import io.vlingo.xoom.lattice.model.ApplyFailedException.Applicable;
...
public abstract class Sourced<T> extends EntityActor implements AppendResultInterest {
  ...
  /*
   * @see io.vlingo.xoom.actors.Actor#start()
   */
  @Override
  public void start() {
    super.start();
  ...
  /*
   * @see io.vlingo.xoom.actors.Actor#viewTestStateInitialization(io.vlingo.xoom.actors.testkit.TestContext)
   */
  @Override
  ...
  /*
   * @see io.vlingo.xoom.actors.Actor#viewTestState()
   */
  @Override
  ...
  public final <S, ST> void appendResultedIn(
          final Outcome<StorageException, io.vlingo.xoom.symbio.store.Result> outcome, final String streamName, final int streamVersion,
   ...
   */
  @Override
  public final <S, ST> void appendAllResultedIn(final Outcome<StorageException, io.vlingo.xoom.symbio.store.Result> outcome, final String streamName,
