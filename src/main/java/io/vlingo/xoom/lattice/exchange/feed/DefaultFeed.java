...
public class DefaultFeed implements Feed {
  ...
  /**
   * @see io.vlingo.xoom.lattice.exchange.feed.Feed#entryReaderType()
   */
  @Override
  ...
  /*
   * @see io.vlingo.xoom.lattice.exchange.feed.Feed#feederType()
   */
  @Override
  ...
  /**
   * @see io.vlingo.xoom.lattice.exchange.feed.Feed#feeder()
   */
  @Override
  ...
  /**
   * @see io.vlingo.xoom.lattice.exchange.feed.Feed#exchangeName()
   */
  @Override
